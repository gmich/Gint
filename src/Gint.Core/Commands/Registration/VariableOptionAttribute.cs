...
namespace Gint
{
    ...
    {
        public VariableOptionAttribute(int priority, string argument,  string longArgument, bool allowMultiple, string helpCallbackMethodName, string suggestionsCallback = null)
        {
            Priority = priority;
            Argument = argument;
